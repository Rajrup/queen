"""
Plot GT vs DracoGS-decompressed model quality per frame (PSNR and SSIM).
...
def main():
    ...
    ax1.plot(x, decomp_psnr, "s-", label="DracoGS decompressed", color="coral", markersize=3)
    ax1.set_ylabel("PSNR (dB)")
    ax1.set_title(f"Quality per frame: GT vs DracoGS [{args.config_name}, {args.dataset_name}, {args.sequence_name}]")
    ...
    ax2.plot(x, decomp_ssim, "s-", label="DracoGS decompressed", color="coral", markersize=3)
