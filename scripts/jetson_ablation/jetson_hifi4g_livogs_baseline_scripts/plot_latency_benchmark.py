#!/usr/bin/env python3
"""Publication-quality plots for the latency & resource benchmark.
...
SEQ_ABBREV = {
    "4K_Actor1_Greeting": "A1-Greet",
    "4K_Actor2_Dancing": "A2-Dance",
    "4K_Actor3_Violin": "A3-Violin",
    "4K_Actor4_Dancing": "A4-Dance",
    "4K_Actor5_Oil-paper_Umbrella": "A5-Umbrella",
    "4K_Actor6_Changing_Clothes": "A6-Clothes",
    "4K_Actor7_Nunchaku": "A7-Nunchaku",
}
...
def get_benchmark_dir(data_path: str, seq: str, pipeline: str) -> str:
    return str(
        Path(data_path) / "train_output" / DATASET_NAME / seq
        / "latency_benchmark" / pipeline
    )
...
# ---------------------------------------------------------------------------
def main() -> None:
    p = argparse.ArgumentParser(description="Plot latency benchmark results")
